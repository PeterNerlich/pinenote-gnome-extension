% pinenote-gnome-extension(SECTION) | User Commands
%
% "June  2 2023"
...
pinenote-gnome-extension - program to do something

# SYNOPSIS

**pinenote-gnome-extension** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**pinenote-gnome-extension** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **pinenote-gnome-extension** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**pinenote-gnome-extension** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    pinenote-gnome-extension. See **foo.conf**(5) for further details.
...
**pinenote-gnome-extension** provides some return codes, that can be used in scripts:
